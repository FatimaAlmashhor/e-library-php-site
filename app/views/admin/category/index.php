...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <h4 class="fw-bold py-3 mb-2">Categories List</h4>
                ...
                <table class="datatables-permissions table border-top dataTable no-footer dtr-column"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span
                                    class="badge bg-label-primary me-1"><?php echo $categoy->is_active == 1 ? 'active' : 'Not active' ?></span>
                            </td>
                            <td>
                                <?php echo $categoy->created_by ?>
                            </td>
                            <td>
                                <div class="dropdown">
