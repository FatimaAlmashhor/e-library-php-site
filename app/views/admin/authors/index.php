...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <h4 class="fw-bold py-3 mb-2">Authors List</h4>
                ...
                <div class="row mx-1">
                    ...
                    <div class="col-sm-12 col-md-9">
                        <div
                            ...
                            <div class="dt-buttons"><a href='/admin/authors/add'
                ...
                <table class="datatables-permissions table border-top dataTable no-footer dtr-column"
                    ...
                    <thead>
                        <tr role="row">
                            ...
                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1"
                                style="width: 168px;" aria-label="Name: activate to sort column ascending">Email</th>
                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1"
                            ...
                            <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 280px;"
                                aria-label="Assigned To">Activition</th>
                            <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 300px;"
                                aria-label="Created Date">Created_by</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> <strong>
                                    <?php echo $author->name ?></strong></td>

                            <td><span
                                    class="badge bg-label-primary me-1"><?php echo $author->is_active == 1 ? 'active' : 'Not active' ?></span>
                            </td>
                            <td>
                                <?php echo $author->created_by  ?>
                            </td>
                            <td>
                                <div class="dropdown">
