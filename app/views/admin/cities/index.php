...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <h4 class="fw-bold py-3 mb-2">Cities List</h4>
                ...
                <div class="row mx-1">
                    ...
                    <div class="col-sm-12 col-md-9">
                        <div
                            ...
                            <div class="dt-buttons"><a href='/admin/cities/add'
                ...
                <table class="datatables-permissions table border-top dataTable no-footer dtr-column"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> <strong>
                                    <?php echo $city->name ?></strong></td>

                            <td><span
                                    class="badge bg-label-primary me-1"><?php echo $city->is_active == 1 ? 'active' : 'Not active' ?></span>
                            </td>
                            <td>
                                <?php echo $city->created_by  ?>
                            </td>
                            <td>
                                <div class="dropdown">
