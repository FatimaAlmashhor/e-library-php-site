                ...
                <table class="datatables-permissions table border-top dataTable no-footer dtr-column"
                    ...
                    <thead>
                        <tr role="row">
                            ...
                            <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 300px;"
                                aria-label="Created Date">Role</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> <strong>
                                    <?php echo $user->name ?></strong></td>

                            <td><span
                                    class="badge bg-label-primary me-1"><?php echo $user->is_active == 1 ? 'active' : 'Not active' ?></span>
                            </td>
                            <td>
                                <?php echo $user->role_id   == 1 ? "Admin" : "nomal" ?>
                            </td>
                            <td>
                                <div class="dropdown">
