<div id='show_register_model'
    class=" hidden top-0 fixed mode w-screen h-screen flex justify-center items-center bg-black bg-opacity-60 z-50">
    <div class=" relative w-96 h-fil border-4 border-white p-3 rounded-md bg-white">
        <button onclick="hide_model('show_register_model')" style="top:-26px; left:-20px; " class=" absolute z-20 flex justify-center items-center overflow-hidden w-12 h-12
        ...
        <div class="flex w-full flex-col justify-center items-center ">
            ...
            <form class="flex flex-col w-full" action='./register' method="POST">
            ...
            <p>
                You do not have an account ?<a href='#' class="text-blue-400">
                    login
                </a>
            </p>
        </div>
